...
* python2.5. "In Ubuntu, where I work, App Engine seems to only work with python2.5":http://www.codigomanso.com/en/2010/05/google-app-engine-en-ubuntu-10-4-lucid-lynx/
